...
<template>
  <div>
    ...
    <div style="text-align:center; margin:2em">
      ...
      <iframe id="youtube" width="560" height="315" src="https://youtu.be/P2c3stcFeZo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
    </div>
