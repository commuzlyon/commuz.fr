...
<div>
  ...
  <section id="sponsors">
    <div id="sponsors__text">
      ...
      <p>Téléchargez la <a class="inline-link" href="/Plaquette_Commuz_2018.pdf" download>plaquette sponsors</a>, ou contactez nos responsables partenariat <a class="inline-link" href="mailto:partenariat@commuz.fr">Aurore et Lisa</a>.</p>
    </div>
...
let data = {
  presentation: '<h2>La Commuz\', c\'est quoi ?</h2>' +
    '<p>La Commuz\' est une comédie musicale organisée chaque année depuis 16 ans par une équipe de 80 étudiants de l\'École Centrale de Lyon et de emlyon business school.</p>' +
    '<p>L\'année dernière, la Commuz\' 2017, Les caprices des Jeux, a conquis plus de 1000 spectateurs lors de trois soirées de spectacle.</p>',
