<template lang="html">
  <div>
    ...
    <div class="section">
      ...
      <div class="section__membres">
        <div v-for="(membre, idMembre) in equipe.bureau" :key="idMembre" class="trombi_membre">
          <img v-if="membre.photo != ''" :src="'/images/equipes/2016/' + membre.photo" alt="">
          <p><b>{{ membre.nom }}</b><br >
            <i>{{ membre.role }}</i>
          </p>
        </div>
    ...
    <div class="section">
      ...
      <div class="section__membres">
        <div v-for="(membre, idMembre) in equipe.communication" :key="idMembre" class="trombi_membre">
          <img v-if="membre.photo != ''" :src="'/images/equipes/2016/' + membre.photo" alt="">
          <p><b>{{ membre.nom }}</b><br >
            <i>{{ membre.role }}</i>
          </p>
...
const equipe = {
  bureau: [
    {
      role: 'Président',
      nom: 'Florian Borgobello',
      photo: 'flobor.png'
    },
    {
      role: 'Vice-pésident',
      nom: 'Gonzague Gendreau',
      photo: 'gongen.png'
    },
    {
  ...
  ac: [
    ...
    {
      role: 'Leandro',
      nom: 'Colin Maillebuau',
      photo: 'colmai.png'
    },
    {
      role: 'Duc de la Rioja / Chef aztèque',
      nom: 'Antoine Rager',
      photo: 'antrag.png'
    },
    {
      role: 'Monsieur Mousse',
      nom: 'Pauline Romagon',
      photo: 'paurom.png'
    },
    {
      role: 'Capitaine Cortes',
      nom: 'Valérian Seuwin',
      photo: 'valseu.png'
    },
    {
  ...
  decors: [
    ...
    {
      role: 'Respo décors',
      nom: 'Lisa Do Nascimento',
      photo: 'lisdon.png'
    },
    {
      role: 'Décoratrice',
      nom: 'Joséphine Larrieu',
      photo: 'joslar.png'
    },
    {
      role: 'Décoratrice',
